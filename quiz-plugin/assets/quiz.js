jQuery(document).ready(function ($) {
    ...
    function displayQuestion() {
        ...
        if (question.featured_image) {
            $('#quiz-popup').append(`<img src="${question.featured_image}" alt="${question.question}" class="quiz-question-image" style="max-width: 10%; height: auto; margin-bottom: 15px;">`);
        }
    ...
    function startTimer() {
        quizTimer = 180; // Reset timer to 3 minutes
